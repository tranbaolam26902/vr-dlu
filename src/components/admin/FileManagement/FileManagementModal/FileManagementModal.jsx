...
export default function FileManagementModal() {
    ...
    return (
        <Modal show={fileManagement.showFileManagementModal} handleClose={handleCloseFileManagementModal}>
            <section className='flex flex-col pb-6 w-[calc(100vw-3rem)] h-[calc(100vh-3rem)] lg:h-[calc(100vh-9rem)] dark:text-white bg-white dark:bg-black border border-gray-500 rounded-lg shadow'>
