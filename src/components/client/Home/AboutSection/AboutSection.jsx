...
export default function AboutSection() {
    ...
    return (
        <section ref={containerRef} id='about' className='mx-auto px-6 min-h-screen'>
            <div className='flex flex-col justify-center gap-y-8 md:gap-y-8 py-8 md:py-16 w-full min-h-screen'>
