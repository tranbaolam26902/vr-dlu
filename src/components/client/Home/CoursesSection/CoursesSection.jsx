...
export default function CoursesSection() {
    ...
    return (
        <section ref={containerRef} className='bg-gray-100 dark:bg-black min-h-screen'>
            <div className='mx-auto px-6 min-h-screen'>
                <div className='flex flex-col justify-center gap-y-8 md:gap-y-16 py-8 md:py-16 w-full min-h-screen'>
