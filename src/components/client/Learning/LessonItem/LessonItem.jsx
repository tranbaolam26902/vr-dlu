...
export default function LessonItem({ lesson }) {
    ...
    return (
        <>
            <div
                role='button'
                className='sticky top-0 flex gap-x-2 px-6 py-4 bg-gray-100 hover:bg-gray-200 dark:bg-dark dark:hover:bg-gray-800'
            ...
            {showSlides &&
                lesson.slides.map((slide) => (
                    <div
                        ...
                        onClick={() => {
                            if (learningSlice.currentSlideId !== slide.id) dispatch(setCurrentSlideId(slide.id));
                        }}
                    >
