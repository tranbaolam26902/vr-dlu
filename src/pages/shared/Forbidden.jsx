...
export default function Forbidden() {
    ...
    return (
        <PageTransition className='fixed inset-0 z-50 flex flex-col items-center pt-40 font-mono text-center px-6 md:px-10 w-screen h-screen bg-white dark:bg-black dark:text-white'>
